        ...
        <div className="mx-auto max-w-7xl px-4 pt-7 pb-5">
          ...
          <div className="flex items-end justify-between gap-4 mt-2">
            ...
            <div className="text-right shrink-0">
              ...
              <button
                onClick={signOut}
                className="block mt-0.5 cursor-pointer font-cond text-xs uppercase tracking-widest text-mist hover:text-card transition-colors duration-150 focus:outline-none"
              >
                Salir
              </button>
            </div>
